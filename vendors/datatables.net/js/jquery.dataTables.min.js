...
(function(h) {
    ...
    function pb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" class="searchPanel ' + b.sFilterInput + '"/>',
            j = d.sSearch,
            j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : g + j,
    ...
    m.defaults = {
        ...
        oClasses: {},
        oLanguage: {
            oAria: { sSortAscending: ": تفعيل لترتيب العمود تصاعديا", sSortDescending: ": تفعيل لترتيب العمود تنازليا" },
            oPaginate: { sFirst: "أول", sLast: "آخر", sNext: "التالي", sPrevious: "السابق" },
            sEmptyTable: "لا توجد أي بيانات متوفرة في الجدول",
            sInfo: "إظهار _START_ إلى _END_ من _TOTAL_ خانة",
            sInfoEmpty: "إظهار 0 إلى 0 من 0 خانة",
            sInfoFiltered: "(تمت تصفيتها من مجموع _MAX_ خانة) ",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "إظهار _MENU_ خانات",
            sLoadingRecords: "انتظر...",
            sProcessing: "معالجة...",
            sSearch: " :بحث",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "لم يتم العثور على بيانات مطابقة"
        },
    ...
    var Mb = m.ext.pager;
    h.extend(Mb, {
        simple: function() { return ["next", "previous"] },
        full: function() { return ["last", "next", "previous", "first"] },
        numbers: function(a, b) {
            return [ya(a,
                b)]
        },
        simple_numbers: function(a, b) { return ["next", ya(a, b), "previous"] },
        full_numbers: function(a, b) { return ["last", "next", ya(a, b), "previous", "first"] },
        _numbers: ya,
        numbers_length: 7
    });
