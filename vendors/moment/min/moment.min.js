...
! function(a, b) { "object" == typeof exports && "undefined" != typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define(b) : a.moment = b() }(this, function() {
    ...
    function ub() { return this.clone().locale("ar").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ") }
    ...
    var Vd = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
        Wd = "يناير_فيفري_مارس_أفريل_ماي_جوان_جويلية_أوت_سبتمبر_أكتوبر_نوفمبر_ديسمبر".split("_"),
        Xd = "ينا_فيف_مار_أفر_ماي_جوا_جوي_أوت_سبت_أكت_نوف_ديس".split("_"),
        Yd = Jd,
        Zd = Jd,
    ...
    var qe = "الأحد_الاثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"),
        re = "الأحد_الاثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"),
        se = "أح_اث_ثل_أر_خم_جم_سب".split("_"),
        te = Jd,
        ue = Jd,
        ve = Jd;
    ...
    var De = Ce,
        Ee = { sameDay: "[اليوم على] LT", nextDay: "[غدا على] LT", nextWeek: "dddd [at] LT", lastDay: "[البارحة على] LT", lastWeek: "[ماضي] dddd [على] LT", sameElse: "L" },
        Fe = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" },
        Ge = "تاريخ غير صالح",
        He = "%d",
        Ie = /\d{1,2}/,
        Je = { future: "in %s", past: "%s مضت", s: "بضع ثواني", m: "دقيقة", mm: "%d دقائق", h: "ساعة", hh: "%d ساعات", d: "يوم", dd: "%d أيام", M: "شهر", MM: "%d أشهر", y: "عام", yy: "%d أعوام" },
        Ke = A.prototype;
